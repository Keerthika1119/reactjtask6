    ...
    <div className="portfolio">
      <div className="header">
        ...
        <div className="contact-info">
          <h3>
            <a href="mailto:sagar.21bec87770@vitapstudent.ac.in">sagar.21bec8777@vitapstudet.ac.in</a>
          </h3>
          <h3>Phone Number: 81406744865</h3>
        </div>
      </div>
      ...
      <div className="contact">
        ...
        <p>Email: 
            <a href="mailto:aviash396@email.com">dsvsgrr04@email.com</a></p><p>Phone: 8142836320
            </p></div></div>);
};
