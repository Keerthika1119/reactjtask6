  ...
  return (
    <div className="portfolio">
      <div className="header">
        <h1>K.Padma Keerthika</h1>
        <h2>Student</h2>
        <div className="contact-info">
          <h3>
            <a href="mailto:keerthiga.21bce8875@vitapstudent.ac.in">keerthiga.21bce8875@vitapstudent.ac.in</a>
          </h3>
          <h3>Phone Number: 9390246019</h3>
        </div>
      </div>
      ...
      <div className="contact">
        ...
        <p>Email: 
            <a href="mailto:Kpk.guntur@gmail.com">Kpk.guntur@gmail.com</a></p><p>Phone: 8142836320
            </p></div></div>);
};
